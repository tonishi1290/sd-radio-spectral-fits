...
DEFAULT_SPECTRAL_TIME_SOURCE = "auto"
DEFAULT_XFFTS_TIMESTAMP_SCALE = "auto"
DEFAULT_XFFTS_GPS_SUFFIX_MEANS = "utc"
...
class InputConfig:
    ...
    spectral_time_source: str = DEFAULT_SPECTRAL_TIME_SOURCE
    xffts_timestamp_scale: str = DEFAULT_XFFTS_TIMESTAMP_SCALE
    xffts_gps_suffix_means: str = DEFAULT_XFFTS_GPS_SUFFIX_MEANS
