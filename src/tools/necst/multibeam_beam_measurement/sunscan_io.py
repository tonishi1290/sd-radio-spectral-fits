...
def build_dataframe_from_config(config: SunScanAnalysisConfig):
    return compat.build_dataframe(
        ...
        spectral_time_source=str(config.input.spectral_time_source),
        xffts_timestamp_scale=str(config.input.xffts_timestamp_scale),
        xffts_gps_suffix_means=str(config.input.xffts_gps_suffix_means),
