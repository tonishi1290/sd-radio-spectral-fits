...
$$
\bar\sigma_X = \operatorname{median}_{\rm robust}\{\sigma_X(y,x)\}
$$

$$
\bar\sigma_Y = \operatorname{median}_{\rm robust}\{\sigma_Y(y,x)\}
$$
...
$$
\sigma_n(y,x)=\operatorname{RMS}_{\rm robust}\{T_n(k,y,x)\mid k\in L\}
$$
